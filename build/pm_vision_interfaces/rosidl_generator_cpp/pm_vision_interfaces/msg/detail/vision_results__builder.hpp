...
class Init_VisionResults_saved_images
{
public:
  explicit Init_VisionResults_saved_images(::pm_vision_interfaces::msg::VisionResults & msg)
  : msg_(msg)
  {}
  Init_VisionResults_image_sharpness saved_images(::pm_vision_interfaces::msg::VisionResults::_saved_images_type arg)
  {
    msg_.saved_images = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_VisionResults_saved_images circles(::pm_vision_interfaces::msg::VisionResults::_circles_type arg)
  {
    msg_.circles = std::move(arg);
    return Init_VisionResults_saved_images(msg_);
  }
