...
#include "pm_vision_interfaces/msg/detail/vision_circle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pm_vision_interfaces::msg::VisionCircle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pm_vision_interfaces::msg::VisionCircle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pm_vision_interfaces::msg::VisionCircle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VisionCircle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const pm_vision_interfaces::msg::VisionCircle *>(
...
static size_t _VisionCircle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VisionCircle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VisionCircle__callbacks = {
...
static rosidl_message_type_support_t _VisionCircle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VisionCircle__callbacks,
...
{
  return &pm_vision_interfaces::msg::typesupport_fastrtps_cpp::_VisionCircle__handle;
}
