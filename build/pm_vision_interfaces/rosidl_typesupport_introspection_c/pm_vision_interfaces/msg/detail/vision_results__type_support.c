...
size_t pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__size_function__VisionResults__saved_images(
  const void * untyped_member)
{
...
const void * pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__get_const_function__VisionResults__saved_images(
  const void * untyped_member, size_t index)
{
  const rosidl_runtime_c__String__Sequence * member =
    (const rosidl_runtime_c__String__Sequence *)(untyped_member);
...
void * pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__get_function__VisionResults__saved_images(
  void * untyped_member, size_t index)
{
...
void pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__fetch_function__VisionResults__saved_images(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rosidl_runtime_c__String * item =
    ((const rosidl_runtime_c__String *)
    pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__get_const_function__VisionResults__saved_images(untyped_member, index));
  rosidl_runtime_c__String * value =
    (rosidl_runtime_c__String *)(untyped_value);
  *value = *item;
}

void pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__assign_function__VisionResults__saved_images(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rosidl_runtime_c__String * item =
    ((rosidl_runtime_c__String *)
    pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__get_function__VisionResults__saved_images(untyped_member, index));
  const rosidl_runtime_c__String * value =
    (const rosidl_runtime_c__String *)(untyped_value);
  *item = *value;
}

bool pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__resize_function__VisionResults__saved_images(
  void * untyped_member, size_t size)
{
  rosidl_runtime_c__String__Sequence * member =
    (rosidl_runtime_c__String__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__VisionResults_message_member_array[6] = {
  {
    "points",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pm_vision_interfaces__msg__VisionResults, saved_images),  // bytes offset in struct
    NULL,  // default value
    pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__size_function__VisionResults__saved_images,  // size() function pointer
    pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__get_const_function__VisionResults__saved_images,  // get_const(index) function pointer
    pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__get_function__VisionResults__saved_images,  // get(index) function pointer
    pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__fetch_function__VisionResults__saved_images,  // fetch(index, &value) function pointer
    pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__assign_function__VisionResults__saved_images,  // assign(index, value) function pointer
    pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__resize_function__VisionResults__saved_images  // resize(index) function pointer
  },
  {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pm_vision_interfaces, msg, VisionResults)() {
  ...
  pm_vision_interfaces__msg__VisionResults__rosidl_typesupport_introspection_c__VisionResults_message_member_array[5].members_ =
