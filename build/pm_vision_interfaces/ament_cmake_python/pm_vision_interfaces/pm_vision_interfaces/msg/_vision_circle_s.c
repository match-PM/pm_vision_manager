...
bool pm_vision_interfaces__msg__vision_circle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pm_vision_interfaces.msg._vision_circle.VisionCircle", full_classname_dest, 52) == 0);
  }
  pm_vision_interfaces__msg__VisionCircle * ros_message = _ros_message;
  {  // center_point
    PyObject * field = PyObject_GetAttrString(_pymsg, "center_point");
    if (!field) {
      return false;
    }
    if (!pm_vision_interfaces__msg__vision_point__convert_from_py(field, &ros_message->center_point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of VisionCircle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pm_vision_interfaces.msg._vision_circle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VisionCircle");
  ...
  {  // center_point
    PyObject * field = NULL;
    field = pm_vision_interfaces__msg__vision_point__convert_to_py(&ros_message->center_point);
    if (!field) {
      return NULL;
    }
    {
