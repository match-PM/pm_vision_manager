...
bool pm_vision_interfaces__msg__vision_area__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pm_vision_interfaces.msg._vision_area.VisionArea", full_classname_dest, 48) == 0);
  }
  pm_vision_interfaces__msg__VisionArea * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of VisionArea */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pm_vision_interfaces.msg._vision_area");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VisionArea");
