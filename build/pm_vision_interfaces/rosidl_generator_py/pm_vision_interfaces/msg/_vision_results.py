...
class VisionResults(metaclass=Metaclass_VisionResults):
    ...
    def __init__(self, **kwargs):
        ...
        self.saved_images = kwargs.get('saved_images', [])
        from pm_vision_interfaces.msg import ImageSharpness
    ...
    def __eq__(self, other):
        ...
        if self.circles != other.circles:
            return False
        if self.saved_images != other.saved_images:
            return False
    ...
    def saved_images(self):
        """Message field 'saved_images'."""
        return self._saved_images

    @saved_images.setter
    def saved_images(self, value):
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'saved_images' field must be a set or sequence and each value of type 'str'"
        self._saved_images = value
