...
static const _VisionLine_type_support_symbol_names_t _VisionLine_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pm_vision_interfaces, msg, VisionLine)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pm_vision_interfaces, msg, VisionLine)),
  }
};
...
{
  return &::pm_vision_interfaces::msg::rosidl_typesupport_cpp::VisionLine_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pm_vision_interfaces, msg, VisionLine)() {
  return get_message_type_support_handle<pm_vision_interfaces::msg::VisionLine>();
}
