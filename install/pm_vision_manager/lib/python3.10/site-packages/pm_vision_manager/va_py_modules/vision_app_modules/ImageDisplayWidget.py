...
class ImageDisplayWidget(QWidget):
    def __init__(self, camera_topic:str = None):
        ...
        #self.refresh_database_button.clicked.connect(self.set_crossval_images())
    ...
    def init_metadata_widget(self):
        ...
        self.ref_database_button = QPushButton("Refresh database")
        metadata_layout.addWidget(self.ref_database_button, 5, 0, 1, 2)
        self.ref_database_button.clicked.connect(self.set_crossval_images)
