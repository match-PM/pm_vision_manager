...
#ifndef PM_VISION_INTERFACES__SRV__DETAIL__EXECUTE_VISION__FUNCTIONS_H_
#define PM_VISION_INTERFACES__SRV__DETAIL__EXECUTE_VISION__FUNCTIONS_H_
 ...
 * calls
 * pm_vision_interfaces__srv__ExecuteVision_Request__init().
...
/**
 * It calls
 * pm_vision_interfaces__srv__ExecuteVision_Request__fini()
 ...
 * pm_vision_interfaces__srv__ExecuteVision_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * pm_vision_interfaces__srv__ExecuteVision_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * pm_vision_interfaces__srv__ExecuteVision_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pm_vision_interfaces
...
/**
 * It calls
 * pm_vision_interfaces__srv__ExecuteVision_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_pm_vision_interfaces
...
/**
 * It allocates the memory for the array and calls
 * pm_vision_interfaces__srv__ExecuteVision_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_pm_vision_interfaces
...
/**
 * It calls
 * pm_vision_interfaces__srv__ExecuteVision_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PM_VISION_INTERFACES__SRV__DETAIL__EXECUTE_VISION__FUNCTIONS_H_
