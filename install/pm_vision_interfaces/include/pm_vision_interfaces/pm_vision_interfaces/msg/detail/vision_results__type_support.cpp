...
size_t size_function__VisionResults__saved_images(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return member->size();
}

const void * get_const_function__VisionResults__saved_images(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__VisionResults__saved_images(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__VisionResults__saved_images(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__VisionResults__saved_images(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__VisionResults__saved_images(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__VisionResults__saved_images(untyped_member, index));
  const auto & value = *reinterpret_cast<const std::string *>(untyped_value);
  item = value;
}

void resize_function__VisionResults__saved_images(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VisionResults_message_member_array[6] = {
  {
    "points",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pm_vision_interfaces::msg::VisionResults, saved_images),  // bytes offset in struct
    nullptr,  // default value
    size_function__VisionResults__saved_images,  // size() function pointer
    get_const_function__VisionResults__saved_images,  // get_const(index) function pointer
    get_function__VisionResults__saved_images,  // get(index) function pointer
    fetch_function__VisionResults__saved_images,  // fetch(index, &value) function pointer
    assign_function__VisionResults__saved_images,  // assign(index, value) function pointer
    resize_function__VisionResults__saved_images  // resize(index) function pointer
  },
  {
